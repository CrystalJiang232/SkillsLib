...
| `references/wuling/` | 五灵 hidden chamber (index, patterns, checklist, flagship) | Trigger: `五灵应象决` or HFT context | Pass 3 complete (patterns + checklist); flagship pending |
...
**Status**: Framework fixed; index in place; pass 1–3 (atomic_queue/CpuPinning, core/msg_parser, option B) folded into `references/wuling/patterns.md` + `checklist.md`.
